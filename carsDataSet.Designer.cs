...
namespace Carro {
    ...
    public partial class carsDataSet : global::System.Data.DataSet {
        ...
        public partial class carrosDataTable : global::System.Data.TypedTableBase<carrosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public carrosRow AddcarrosRow(int ID, string Precio, string Marca, string Fecha) {
        ...
        public partial class carrosRow : global::System.Data.DataRow {
            ...
            public string Precio {
                get {
                    try {
                        return ((string)(this[this.tablecarros.PrecioColumn]));
                    }
                ...
                set {
                    this[this.tablecarros.PrecioColumn] = value;
                }
            }
            ...
            public string Fecha {
                get {
                    try {
                        return ((string)(this[this.tablecarros.FechaColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Fecha\' in table \'carros\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablecarros.FechaColumn] = value;
                }
            }
            ...
            public bool IsPrecioNull() {
                return this.IsNull(this.tablecarros.PrecioColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetPrecioNull() {
                this[this.tablecarros.PrecioColumn] = global::System.Convert.DBNull;
            }
            ...
            public bool IsFechaNull() {
                return this.IsNull(this.tablecarros.FechaColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetFechaNull() {
                this[this.tablecarros.FechaColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Carro.carsDataSetTableAdapters {
    ...
    public partial class carrosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[carros] WHERE (([ID] = @Original_ID) AND ((@IsNull_Precio = 1 AND [Precio] IS NULL) OR ([Precio] = @Original_Precio)) AND ((@IsNull_Marca = 1 AND [Marca] IS NULL) OR ([Marca] = @Original_Marca)) AND ((@IsNull_Fecha = 1 AND [Fecha] IS NULL) OR ([Fecha] = @Original_Fecha)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[carros] ([ID], [Precio], [Marca], [Fecha]) VALUES (@ID, @Preci" +
                "o, @Marca, @Fecha);\r\nSELECT ID, Precio, Marca, Fecha FROM carros WHERE (ID = @ID" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[carros] SET [ID] = @ID, [Precio] = @Precio, [Marca] = @Marca, [Fecha] = @Fecha WHERE (([ID] = @Original_ID) AND ((@IsNull_Precio = 1 AND [Precio] IS NULL) OR ([Precio] = @Original_Precio)) AND ((@IsNull_Marca = 1 AND [Marca] IS NULL) OR ([Marca] = @Original_Marca)) AND ((@IsNull_Fecha = 1 AND [Fecha] IS NULL) OR ([Fecha] = @Original_Fecha)));
SELECT ID, Precio, Marca, Fecha FROM carros WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Precio, Marca, Fecha FROM dbo.carros";
        ...
        public virtual int Fill(carsDataSet.carrosDataTable dataTable) {
        ...
        public virtual carsDataSet.carrosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            carsDataSet.carrosDataTable dataTable = new carsDataSet.carrosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(carsDataSet.carrosDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_Precio, string Original_Marca, string Original_Fecha) {
        ...
        public virtual int Insert(int ID, string Precio, string Marca, string Fecha) {
        ...
        public virtual int Update(int ID, string Precio, string Marca, string Fecha, int Original_ID, string Original_Precio, string Original_Marca, string Original_Fecha) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Precio, string Marca, string Fecha, int Original_ID, string Original_Precio, string Original_Marca, string Original_Fecha) {
            return this.Update(Original_ID, Precio, Marca, Fecha, Original_ID, Original_Precio, Original_Marca, Original_Fecha);
        }
    }
